...
<?php echo $limit; ?>
                                        ...
                                        onPageClick: function (pageNumber) {
                                            ...
                                            jQuery("#queries_data_msgs").load("paginate/nds_messages_for_queries.php?page=" + pageNumber + "&userId=" +<?php echo $theUserId; ?>+"&insti=institution");
                                        }, onInit: function () {
                                            jQuery("#queries_data_msgs").html('loading...');
                                            jQuery("#queries_data_msgs").load("paginate/nds_messages_for_queries.php?page=1" + "&userId=" +<?php echo $theUserId; ?>+"&insti=institution");
                                        }
                                    });
...
<?php echo $limit_; ?>
                                        ...
                                        onPageClick: function (pageNumber) {
                                            ...
                                            jQuery("#suggestions_data_msgs").load("paginate/nds_messages_for_suggestions.php?page=" + pageNumber + "&userId=" +<?php echo $theUserId; ?>+"&insti=institution");
                                        }, onInit: function () {
                                            jQuery("#suggestions_data_msgs").html('loading...');
                                            jQuery("#suggestions_data_msgs").load("paginate/nds_messages_for_suggestions.php?page=1" + "&userId=" +<?php echo $theUserId; ?>+"&insti=institution");
                                        }
                                    });
