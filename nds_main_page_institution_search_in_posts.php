...
WHERE LOWER(P.ogenius_nds_db_community_posts_postdata) LIKE '%$searchKeyword%' AND P.ogenius_nds_db_community_posts_active='0'
  ...
  ORDER BY ogenius_nds_db_community_posts_comments.ogenius_nds_db_community_posts_comments_id DESC LIMIT 20";
                    if ($query_main_page_posts_comments = $database->query($sql_main_page_posts_comments)) {
                        ...
                        if ($main_page_cmmnens_c != 0) {
                            ...
                            ?>
                            <br/>
                            <img class="image48 main_page_comments_collapsible<?php echo "" . $i_mainPage_posts; ?>" onclick="main_page_posts_comments_refresh_down(<?php echo "" . $main_page_the_postId_2017; ?>, this)" src="images/down_new_load.png" style="cursor:pointer;margin-left:48%;" />
