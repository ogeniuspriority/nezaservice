...
$_global_language = "english_NDS_618485740hub5548.xml";
    ...
    //------------
    // echo "".$id_xxxccc88;
    $sql_main_page_institution_suggestion = "SELECT * FROM  ogenius_nds_db_suggestions WHERE        ogenius_nds_db_suggestions_box_id='{$mainpage_institution_box}' AND ogenius_nds_db_suggestions_id<'{$main_page_institution_suggestions_last_id}' ORDER BY ogenius_nds_db_suggestions_id DESC LIMIT 10    ";
