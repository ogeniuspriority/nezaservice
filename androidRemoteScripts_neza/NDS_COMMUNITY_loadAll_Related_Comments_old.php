...
$LastComment_id=$LastComment_id-50;
...
WHERE ogenius_nds_db_community_posts_comments_posts_post_id='{$PostId}' AND	ogenius_nds_db_community_posts_comments_id<='{$NewCOmmentId}'
AND
ogenius_nds_db_community_posts_comments_id>='{$LastComment_id}'
AND     ogenius_nds_db_community_posts_comments_active_status='0' ORDER BY 
	ogenius_nds_db_community_posts_comments_regdate DESC
