...
FROM ogenius_nds_db_community_posts P 
WHERE P.ogenius_nds_db_community_posts_id>'{0}' AND P.ogenius_nds_db_community_posts_poster_id='{$posterId}'
AND P.ogenius_nds_db_community_posts_active='0' ORDER BY P.ogenius_nds_db_community_posts_id DESC LIMIT 70";
...
";
	...
	print("{\"UserCreds\":" . json_encode($posts_USERS) . "}");
	print("--cyuma2017--");
} else if ($_POST['select_directive'] == "trendingposts") {
...
FROM ogenius_nds_db_community_posts P 
WHERE P.ogenius_nds_db_community_posts_id>'{0}' AND P.ogenius_nds_db_community_posts_active='0'
ORDER BY P.ogenius_nds_db_community_posts_views DESC LIMIT 70 ";
