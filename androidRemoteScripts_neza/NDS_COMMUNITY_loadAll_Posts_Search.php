...
WHERE P.ogenius_nds_db_community_posts_id>'{0}' AND LOWER(P.ogenius_nds_db_community_posts_postdata) LIKE '%$keyword%'
 AND P.ogenius_nds_db_community_posts_active='0'
ORDER BY P.ogenius_nds_db_community_posts_id DESC LIMIT 70";
