...
";
    ...
    for ($i_mainPage_posts = 0; $i_mainPage_posts < $main_page_common_user_posts_count; $i_mainPage_posts++) {
        ...
        <div class="panel panel-default">
            ...
            <div class="scrolls" style="margin-left: 5%;margin-bottom: 10px;max-height: 240px; min-width: 95%;overflow-y: scroll">
                <div> <!--New...--></div>
                    ...
                    if ($query_main_page_posts_comments = $database->query($sql_main_page_posts_comments)) {
                        ...
                        while ($res_main_page_posts_comments = mysqli_fetch_array($query_main_page_posts_comments)) {
                            ...
                            if ($main_page_cmmnens_c == 0) {
                                ?>
                                <img class="image24 main_page_institution_comments_collapsible<?php echo "" . $i_mainPage_posts; ?>" onclick="main_page_institution_posts_comments_refresh_up(<?php echo "" . $main_page_the_postId_2017; ?>, this)" src="images/up_new_load.png" style="cursor:hand;margin-left:40%;width: 30px;height: 30px;border-radius: 5px;box-shadow: 2px 2px 2px gray;border-top: 1px solid gray;border-left: 1px solid gray;" />
                                <?php
                            ...
                            <div class="startcolstart" style="min-width:95%; ">
                                <div class="startrowspace" style="min-width:95%">
                                    <div class="startrow">
                                        <?php
                                        //-------------The profile page dilemma--
