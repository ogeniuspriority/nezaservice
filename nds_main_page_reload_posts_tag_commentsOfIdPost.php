    ...
    if ($query_main_page_posts_comments = $database->query($sql_main_page_posts_comments)) {
        ...
        while ($res_main_page_posts_comments = mysqli_fetch_array($query_main_page_posts_comments)) {
            ...
            if ($main_page_cmmnens_c == 0) {
                ?>
                <img onclick="main_page_posts_comments_refresh_up(<?php echo "" . $main_page_the_postId_2017; ?>, this)" src="images/up_new_load.png" style="cursor:pointer;" class="image24" />
                <?php
        ...
        if ($main_page_cmmnens_c != 0) {
            ...
            ?>
            <br/>
            <img onclick="main_page_posts_comments_refresh_down(<?php echo "" . $main_page_the_postId_2017; ?>, this)" src="images/down_new_load.png" style="cursor:pointer;" class="image24" />
