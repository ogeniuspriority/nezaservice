...
if (isset($_FILES['main_page_community_suggest_video_2017_form'])) {
    postDocs($_FILES['main_page_community_suggest_video_2017_form']);
...
function postDocs($file) {
    ...
    if ($fileExt == "MP4" || $fileExt == "WEBM" || $fileExt == "OGG") {
        ...
        if (!$file || empty($file) || !is_array($file)) {
            ...
            $path = "../Community_Admin/NDS_suggested_videos/" . $target_file;
