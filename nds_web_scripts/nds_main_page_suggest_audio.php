...
if (isset($_FILES['main_page_community_suggest_audio_2017'])) {
    postDocs($_FILES['main_page_community_suggest_audio_2017']);
}
...
function postDocs($file) {
    ...
    if ($fileExt == "MP3" || $fileExt == "OGG" || $fileExt == "MP3 Format Sound" || $fileExt == "OGG Format Sound") {
        ...
        if (!$file || empty($file) || !is_array($file)) {
            ...
            $path = "../Community_Admin/NDS_suggested_audios/" . $target_file;
