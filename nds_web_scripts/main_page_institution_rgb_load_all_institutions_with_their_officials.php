        ...
        while ($res_institutions_only = mysqli_fetch_array($query_institutions_only)) {
            ...
            <div class="startrowstart"><?php
                if ($indiv_social_goo < 1) {
                    ?><img  src="uploaded_images/<?php echo "" . (!empty($indiv_avatar)) ? $indiv_avatar : "nds_avatar.png"; ?>" style="margin: 0px 3px;border-radius: 50%" class="image24" />
                ...
                <?php } else { ?><img  src="<?php
                    ...
                    ?>" class="image24" style="border-radius: 50%; margin: 0px 3px" /> <?php } ?><span style="margin: 0px 4px;"><b><?php echo "" . $institution_profile_page_institution; ?></b></span>
            </div>
