...
$queryTag= $_POST['queryTag'];
$queryId = $_POST['queryId'];
$common_user_settings_the_id = $_POST['common_user_settings_the_id'];
$msgData = addslashes($msgData);
$date = date("Y-m-d H:i:s");
//------------send messages-
$queryID = $queryId;
$common_user_settings_the_id = $common_user_settings_the_id;
$CommentData = $msgData;
$CommentData = addslashes($CommentData);
//---------------
$external_visibility = "visible_to_public";
...
('{$queryID}','{$CommentData}','{$date}','{$common_user_settings_the_id}','{$queryTag}','{$external_visibility}')";
