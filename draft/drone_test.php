...
WHERE P.ogenius_nds_db_community_posts_id<'{$OldId}' ANDP.ogenius_nds_db_community_posts_id>'{$range}' AND P.ogenius_nds_db_community_posts_active='0'
ORDER BY P.ogenius_nds_db_community_posts_id ";
