...
<body style="background: white;">
    ...
    <section class="main_page_col" style="width: 100%;margin-top: 2.5%;color: #999933;" id="mainscroll_sec">
        <div style="width: 25%;float: left;padding: 0px;" id="main_page_col_left">
            <div class="mainPageNotificationHeader" id="mainpage_notification" style="">
                <h4 style="text-align: left;padding-left: 10px;"><?php
                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_0("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_0("system_config_xml/" . $_global_language)->item(0)->textContent;
                    } else {
                        ?>
                        Notification
                    <?php } ?>
                ...
                <div style="overflow:hidden;box-shadow:2px 4px 8px rgba(0, 0, 0, .5);margin-top:-4%;margin-left:20%;height: 50px;width: 50px;border-radius: 50px;position: absolute;background: #663366;text-align: center;">
                    <p style="color: #999933;">
                        <span id="main_page_institution_notification_counter" style="font-size: 13px;">0</span>
                    </p>
                </div>
            </div>
            <div class="scrolls" style="background: white;overflow-y: scroll;height: 240px;">
                <div id="main_page_institution_notification_counter_messenger">
                    ...
                    <h4  style="font-style: italic;color: #999933;margin-left:10%;"> <?php
                        if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_1("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                            echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_1("system_config_xml/" . $_global_language)->item(0)->textContent;
                        } else {
                            ?>
            ...
            <div class="mainPage_Message" id="mainpageMessage" style="">
                <h4 style="text-align: left;padding-left: 10px;"><?php
                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_2("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_2("system_config_xml/" . $_global_language)->item(0)->textContent;
                    } else {
                        ?>
                        Message
                    <?php } ?></h4>
            ...
            <div class="scrolls" style="background: white;overflow-y: scroll;height: 440px;">
                <div id="main_page_noification_tag_2017">
                    ...
                    <h4 style="font-style: italic;color: #999933;margin-left:10%;"> <?php
                        if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_3("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                            echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_3("system_config_xml/" . $_global_language)->item(0)->textContent;
                        } else {
                            ?>
        ...
        <div style="width: 44%;float: left;border-left: 1px solid #cdcdcd;" id="main_page_col_middle">
            <div style="color:#999933;padding: 8px;background: #cdcdcd;border: 1px solid gray;border-radius: 7px;">
                <?php
