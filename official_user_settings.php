                        ...
                        if ($query_notification_new_msg_coming = $database->query($sql_notification_new_msg_coming)) {
                            ...
                            if ($notification_new_msg_coming == 0) {
                                ...
                                <li class="startrow">
                                    ...
                                    <input checked="true" style="margin:4px" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["new_msg_coming"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                ...
                                if ($notification_new_msg_coming_status == 0) {
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input  style="margin:4px" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["new_msg_coming"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:4px" checked="true" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["new_msg_coming"]; ?>, 'newmsg', '1')"   type="checkbox" />
                        ...
                        if ($query_notification_copy_my_mail_add = $database->query($sql_notification_copy_my_mail_add)) {
                            ...
                            if ($notification_copy_my_mail_add == 0) {
                                ...
                                <li class="startrow">
                                    ...
                                    <input checked="true" style="margin:0px 4px" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["cc_my_mail_add"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                ...
                                if ($notification_copy_my_mail_add_status == 0) {
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px"  onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["cc_my_mail_add"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px" checked="true" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["cc_my_mail_add"]; ?>, 'newmsg', '1')"   type="checkbox" />
                        ...
                        if ($query_notification_all_notifications_add = $database->query($sql_notification_all_notifications_add)) {
                            ...
                            if ($notification_all_notifications_add == 0) {
                                ...
                                <li class="startrow">
                                    ...
                                    <input checked="true" style="margin:0px 4px" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["all_notifications"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                ...
                                if ($notification_all_notification_status == 0) {
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px"  onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["all_notifications"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px" checked="true" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["all_notifications"]; ?>, 'newmsg', '1')"   type="checkbox" />
                        ...
                        if ($query_notification_all_notifications_add = $database->query($sql_notification_notify_my_nber)) {
                            ...
                            if ($notification_notify_my_nber == 0) {
                                ...
                                <li class="startrow">
                                    ...
                                    <input checked="true" style="margin:0px 4px"class="form-control" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["notify_my_nber"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                ...
                                if ($notification_notification_notify_my_nber_status == 0) {
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px"  onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["notify_my_nber"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px" checked="true" onclick="official_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["notify_my_nber"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                        <label><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_21("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_21("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            } else {
                        ...
                        if ($query_preference_stay_logged_in = $database->query($sql_preference_stay_logged_in)) {
                            ...
                            if ($preference_stay_logged_in == 0) {
                                ...
                                <li class="startrow">
                                    ...
                                    <input checked="true" style="margin:0px 4px" onclick="official_user_settings_change_preferences_status(<?php echo "" . $preferences_validators_2017_ids["stay_logged_in"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                ...
                                if ($preference_stay_logged_in_status == 0) {
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px"  onclick="official_user_settings_change_preferences_status(<?php echo "" . $preferences_validators_2017_ids["stay_logged_in"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin:0px 4px" checked="true" onclick="official_user_settings_change_preferences_status(<?php echo "" . $preferences_validators_2017_ids["stay_logged_in"]; ?>, 'newmsg', '1')"   type="checkbox" />
...
///-------------Mail updates
                        ...
                        if ($query_preference_receive_mail_updates = $database->query($sql_preference_receive_mail_updates)) {
                            ...
                            if ($preference_stay_receive_mail_updates == 0) {
                                ...
                                <li class="startrow">
                                    ...
                                    <input checked="true" style="margin: 0px 4px" onclick="official_user_settings_change_preferences_status(<?php echo "" . $preferences_validators_2017_ids["receive_mail_updates"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                ...
                                if ($preference_receive_mail_updates_status == 0) {
                                    ...
                                    <li class="startrow">
                                        ...
                                        <input style="margin: 0px 4px"  onclick="official_user_settings_change_preferences_status(<?php echo "" . $preferences_validators_2017_ids["receive_mail_updates"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                        <label><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_23("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_23("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            } else {
                                    ...
                                    ?>                                    
                                    <li class="startrow">
                                        <input style="margin: 0px 4px" checked="true" onclick="official_user_settings_change_preferences_status(<?php echo "" . $preferences_validators_2017_ids["receive_mail_updates"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                        <label><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_23("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_23("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            } else {
                    ...
                    <div>
                        <div>
                            ...
                            <div class="container-fluid startrowstart">
                                <div>
                                    <h4><?php
                                ...
                                if ($query_privacy_suggest = $database->query($sql_privacy_suggest)) {
                                    ...
                                    while ($res_privacy_suggest = mysqli_fetch_array($query_privacy_suggest)) {
                                        ...
                                        if ($privacy_suggest_set_txt_descr_1 == 1) {
                                            ...
                                            <tr>
                                                <td>
                                                    <input checked="true" style="margin: 0px 4px" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "" . $privacy_suggest_set_id; ?>, '0')" id="nds_privacy_suggest_all_details"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                            ...
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "" . $privacy_suggest_set_id; ?>, '1')" id="nds_privacy_suggest_username_and_loc" name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                            ...
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "" . $privacy_suggest_set_id; ?>, '2')" id="nds_privacy_suggest_username_only"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                            ...
                                            <tr>
                                                <td>
                                                    <input  style="margin: 0px 4px" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "" . $privacy_suggest_set_id; ?>, '0')" id="nds_privacy_suggest_all_details"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_35("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_35("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            ...
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" checked="true" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "" . $privacy_suggest_set_id; ?>, '1')" id="nds_privacy_suggest_username_and_loc" name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            ...
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" checked="true" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "" . $privacy_suggest_set_id; ?>, '2')" id="nds_privacy_suggest_username_only"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent;
...
//------When nothing is registered yet!--------------------------------
                                ...
                                if ($_2017_check_if_real == 0) {
                                    ...
                                    <tr>
                                        <td>
                                            <input style="margin: 0px 4px" checked="true" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "23"; ?>, '0')" id="nds_privacy_suggest_all_details"  name="suggestionInstan" type="radio" />
                                        </td>
                                        <td><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_35("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_35("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input style="margin: 0px 4px" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "23"; ?>, '1')" id="nds_privacy_suggest_username_and_loc" name="suggestionInstan" type="radio" />
                                        </td>
                                        <td><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input style="margin: 0px 4px" onchange="nds_privacy_suggest_action_tools_official(this,<?php echo "23"; ?>, '2')" id="nds_privacy_suggest_username_only"  name="suggestionInstan" type="radio" />
                                        </td>
                                        <td><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_official_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent;
                                ...
                                while ($res_privacy_posts = mysqli_fetch_array($query_privacy_posts)) {
                                    ...
                                    if ($_privacy_posts_set_txt_descr_1 == 1) {
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" checked="true" id="community_user_settings_privacy_posts_0" onclick="nds_privacy_check_which_posts_0_official(this)" name="usernameChoice" type="radio" />
                                                </td>
                                                <td><?php
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" name="usernameChoice" id="community_user_settings_privacy_posts_1" onclick="nds_privacy_check_which_posts_0_official(this)" type="radio" />
                                                </td>
                                                <td><?php
                                                    ...
                                                    <?php } ?></td>
                                                <td>
                                                    <input style="margin: 0px 4px" id="comm_user_settings_MyOtherName" onclick="nds_privacy_check_which_posts_0_official(this)" type="text" class="accountRegPuts" disabled="disabled" placeholder="<?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_42("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        ...
                                                        ?>
                                                               MyOtherName
                                                           <?php } ?>" /><input style="margin: 0px 4px" onclick="enableThisIndivProfPageDiv(this, 'comm_user_settings_MyOtherName')" type="checkbox" id="community_user_settings_myOther_Name" />
                                                </td>
                                                <td>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" onclick="nds_privacy_check_which_posts_0_official(this)" id="community_user_settings_privacy_posts_0" name="usernameChoice" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_40("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_40("system_config_xml/" . $_global_language)->item(0)->textContent;
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input style="margin: 0px 4px" checked="true" id="community_user_settings_privacy_posts_1" onclick="nds_privacy_check_which_posts_0_official(this)" name="usernameChoice" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_41("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_41("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    ...
                                                    <?php } ?></td>
                                                <td>
                                                    <input style="margin: 0px 4px" id="comm_user_settings_MyOtherName" value="<?php echo "" . $_privacy_posts_set_txt_descr_2; ?>" type="text" class="accountRegPuts" disabled="disabled" placeholder="<?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_42("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_42("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                                ...
                                                <td>
                                                    <input style="margin: 0px 4px" onclick="nds_privacy_save_which_posts_1_official()" type="button" value="<?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_43("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_43("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            <?php } ?></td>
                                        <td>
                                            <input style="margin: 0px 4px" id="comm_user_settings_MyOtherName" type="text" class="accountRegPuts" disabled="disabled" placeholder="<?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_42("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_42("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            } else {
                                                ?>
