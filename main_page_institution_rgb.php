...
<div id="main_page_institution_rgb_reply_popup" style="z-index:10000;background:rgba(20,20,20,.6);max-width:40%;min-width:200px;min-height:200px;visibility:hidden;position: absolute;border-radius:5px;padding: 5px;box-shadow:2px 2px 2px #333333;" >
    <div class="panel-heading">
        <button type="button" onclick="main_page_rgb_reply_to_query_hide()" class="btn" style="color:red;">&times;</button>
    </div>
    <div class="scrolls" id="main_page_institution_rgb_reply_popup_data" style="overflow-y:scroll;height:300px;text-align:center;padding:6px;border-radius:4px;box-shadow: 1px 1px 1px #cdcdcd;color:#333333;background: #cdcdcd;margin-top:30px;">
        <div> </div>
    </div>
    ...
    <div style="text-align:center;padding:6px;border-radius:4px; box-shadow:1px 1px 1px rgba(255,255,255,.7);color:#333333;background: #cdcdcd;margin-top:70px;">
        <table>
            <tr>
                <td>
                    <textarea id="main_page_institution_suggesttion_comment_data_rgb_queries_2017" onkeydown="textAreaAdjust(this)" style="padding:5px;color:black;font-size:14px;background: white;border-radius: 4px;border-style: none;width:300px;min-height: 100px;" class="accountRegPuts"></textarea>
                </td>
                <td>
                    <input type="hidden" id="main_page_institution_suggest_comment_pool_view_strategy_rgb_queries_2017" value="visible_to_public" />
                    <form>
                        <table>
                            <tr>
                ...
                <td>
                    <input type="button" onclick="main_page_institution_suggest_comment_2017_send_rgb_queries_2017()"  value="Send Comment" style="padding: 4px;" class="btn" />
                </td>
            </tr>
        </table>
    </div>
...
<div id="main_page_institution_rgb_forward_as_popup"class="panel" style="">
    <div class="panel-heading startrowspace">
        ...
        <button type="button" onclick="main_page_rgb_forward_this_query_hide()"  style="color:red;">&times;</button>  
    </div>
    <div id="main_page_institution_rgb_forward_as_popup_data" style="box-shadow: 1px 1px 1px rgba(255,255,255,.7);color:#333333;background: #cdcdcd;">
        <div class="startcolstart" style="background:#cdcdcd; width: 100%">

            <ul style="">

                <li onclick="main_page_institution_forward_as_tools('delegation', this)" id="delegationx" style="width: 100%" class="delegationThings">
                    <?php
                ...
                <li onclick="main_page_institution_forward_as_tools('consultation', this)" id="consultationx" style="width: 100%"class="delegationThings">
                    <?php
...
<div id="main_page_institution_rgb_forward_as_popup_contingency" class="panel" style="z-index:10000;height:270px;visibility:hidden;position: absolute;border-radius:5px;padding: 5px;box-shadow: 1px 1px 1px #cdcdcd,rgba(255,255,255,.7);">
    <div class="panel-heading startrowspace" id="main_page_institution_rgb_forward_as_popup_data_contingency" style="text-align:center;padding:6px;border-radius:4px;box-shadow: 1px 1px 1px #cdcdcd,rgba(255,255,255,.7);color:#333333;background: #cdcdcd">
        ...
        <button type="button" onclick="main_page_rgb_forward_this_query_hide_contingency()" class="btn" style="color:red">&times</button>
    </div>
    <div id="main_page_institution_rgb_forward_as_popup_data_contingency" style="padding-top:5px;">
        <ul id="messagedialogtab" class="nav nav-tabs">
            <li onclick="drawtab('institution')" class="" style="cursor:pointer" id="institution-link">
                <a style="text-decoration: none;color:#333333;">To Institutions</a>
            </li>
            <li id="individual-link" style="cursor:pointer" onclick="drawtab('individual')" class="active">
                <a style="text-decoration: none;color:#333333" >To Individuals</a>
            </li>
        </ul>          
        <div class="tab-content" id="rgb_my_whole_tabs_2017" style="margin-bottom:10px;">
            <div id="institution" class="tab-pane fade in" style="padding-top:5px;background-color: #e0e0e0">
                <div class="startrowstart" >
                    <input onkeyup="main_page_institution_search_through_institutions_ForDelegation(this)" class="form-control" type="text" placeholder="Search Institution here" />
                    <input class="btn btn-primary" onclick="main_page_institution_rgb_load_all_institutions_only()" type="button" value="View All" />
                </div>
                <div id="ToInstitutions_search_results" class="scrolls" style="padding: 5px;height: 270px;overflow-y: scroll;">

                </div>
            </div>
            <div id="individual" class="tab-pane fade in active" style="padding-top: 5px;background-color: #e0e0e0">
                <div class="startrowstart">
                    <input class="form-control" onkeyup="main_page_institution_search_through_institutions_officials_ForDelegation(this)" type="text" placeholder="Search Individuals here" />
                    <input class="btn btn-primary" onclick="main_page_institution_rgb_load_all_institutions_with_officials()" type="button" value="View All" />
                </div>
                <div id="ToIndividuals_search_results" class="scrolls">
                    <div id="rgb_forward_query" style="padding: 5px;height: 270px;overflow-y: scroll;">
...
<div class="main-content">
    <div class="container-fluid">
        <div id="panel1" class="col-md-3">
            <div class="notifpanel panel-default">
                <div id="mainpage_notification" class="panel-heading centerrowspace">
                    ...
                    <span class="badge" id="main_page_institution_rgb_notification_counter">0</span>
                </div>
                ...
                <div class="panel-heading centerrowspace">
                    <h5><?php
                        if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_5("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                            ...
                            Message
                        <?php } ?>
                    </h5><div><a href="message_institution_rgb.php" data-toggle="tooltip" data-placement="bottom" title="View all messages" target="_blank" style="text-decoration: none"><i style="margin:0px 6px; cursor: pointer; color: #0B1022" class="fa fa-external-link-square"></i></a><span class="badge" id="mainpageMessage_message_count">0</span></div>
                </div>
                <div class="panel-body">
        ...
        <div id="panel2" class="col-md-5">
            <script type="text/javascript">
                function drawtab(n) {
                    switch (n) {
                        case 'queries':
                            $('#messagedialogtab').children().removeClass('active');
                            $('#queries-link').addClass('active');
                            $('#my-tabcontent').children().removeClass('active');
                            $('#queries').addClass('active');
                            break;
                        case 'suggestion':
                            $('#messagedialogtab').children().removeClass('active');
                            $('#suggestion-link').addClass('active');
                            $('#my-tabcontent').children().removeClass('active');
            ...
            <ul id="messagedialogtab" class="nav nav-tabs">
                <li onclick="drawtab('queries')" class="active" style="cursor:pointer" id="queries-link">
                ...
                <li id="suggestion-link" style="cursor:pointer" onclick="drawtab('suggestion')" class="">
                    <a data-toggle="tab"  href="#suggestion">
                        <?php
            ...
            <div class="tab-content" id="myTabContent" style="margin-bottom:10px;">
                <div id="queries" class="tab-pane fade in active">
                            ...
                            <form>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_8("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                ...
                                                ?>
                                                       By Name
                                                   <?php } ?>" id="main_page_institution_rgb_sort_2017_by_name" class="form-control" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_9("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                ...
                                                ?>
                                                       By Keyword
                                                   <?php } ?>" id="main_page_institution_rgb_sort_2017_by_keyword" class="form-control" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <select id="main_page_institution_rgb_sort_2017_by_gender" class="form-control">
                                                <option><?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id='main_page_institution_rgb_sort_2017_by_marital_status' class="form-control">
                                                <option><?php
                                    ...
                                    <tr>
                                        <td><input onclick="main_page_institution_rgb_sort_classA_query()" type="button" value="<?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_institution_19("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                ...
                                                ?>
                                                       Sort
                                                   <?php } ?>" class="btn btn-info" style="margin-left: 0px;" /></td>
                                    </tr>
                                </table>
                        ...
                        <div style="float: left;width: 54%;">
                            <form name="class_Inst_b">
                                <table style="margin-left: -4px">
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            <?php } ?></td>
                                        <td>
                                            <select id="main_page_institution_rgb_sort_2017_by_category" class="form-control">
                                ...
                                <table style="margin-left: -4px">
                                    <tr>
                                        ...
                                        <td><?php
                                            ...
                                            <?php } ?></td>
                                        <td>
                                            <select id="main_page_institution_rgb_sort_2017_by_progress" class="form-control">
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <input onclick="main_page_institution_rgb_sort_classD_query('ASC')" class="btn btn-info" type="button" value="<?php
                                            ...
                                            <input onclick="main_page_institution_rgb_sort_classD_query('DESC')" class="btn btn-info" type="button" value="<?php
                    ...
                    <div class="mainpanel" style="overflow-y: auto;">
                        ...
                        <div onclick="main_page_institution_rgb_load_more_queriesUp()" style="margin-top: 10px;margin-left: 48%;"> <img src="images/up_new_load.png" class="image24" /></div>
            ...
            ON ogenius_nds_db_rgb_query.ogenius_nds_db_rgb_query_query_provider=ogenius_nds_db_normal_users.ogenius_nds_db_normal_users_id
                 ...
                 ORDER BY ogenius_nds_db_rgb_query_id DESC LIMIT 60      ";
                        ...
                        <div onclick="main_page_institution_rgb_load_more_queriesDown()" style="margin-top: 10px;margin-left: 48%;"> <img src="images/down_new_load.png" class="image24" /></div>
                ...
                <div id="suggestion" class="tab-pane fade in">
                    ...
                    <div class="scrolls" style="overflow-y: auto">
                        <div id="main_page_institution_pic_view_container" style="visibility:hidden;background:rgba(30,30,30,0.7);z-index:10000;position: fixed;border-radius: 5px;box-shadow: 2px 2px 2px #cdeded;width: 60%;height: 60%;text-align: center;border-left: 1px solid #cdeded;border-top: 1px solid #cdeded;">
                            <input type="button" onclick="main_page_institution_pic_view()" value="X" class="btn" style="color:red;padding: 2px;float: right;margin-right: 10%;margin-top: 4px;" />
                            <div style="clear:both;width: 98%;height: 80%;">
                                <img src="" id="main_page_institution_pic_view_container_img_src" style="max-height: 98%;max-width: 98%;" />
...
//-------------The profile page dilemma--
                        ...
                        <div class="panel-footer centerrowspacearound post-area">
                            ...
                            <textarea type="textarea" class="form-control" id="main_page_institution_community_post_field" onchange="enlarge(this)"  onkeyup="enlarge(this)" placeholder='<?php
                                        ...
                                        <div class="post-stats">
                                            ...
                                            <ul class="post-item-button startrow">
                                                    ...
                                                    <form>
                                                        <ul class="startcolstart">
                                                            ...
                                                            <li class="startrowspace">
                                                                <textarea title="<?php echo "theMeRadioFlag_c" . $i_mainPage_posts; ?>" onclick='main_page_flag_this_post_using_other_focus(this,<?php echo "" . $books_main_page_posts[$i_mainPage_posts]['ogenius_nds_db_community_posts_id']; ?>,<?php echo "theMeRadioFlag_c" . $i_mainPage_posts; ?>)' name="" id="<?php echo "main_page_flag_motion" . $i_mainPage_posts; ?>" onkeyup="enlarge(this)" onchange="enlarge(this)" class="form-control"></textarea>
                                                ...
                                                if ($books_main_page_users_creds[$i_mainPage_posts]['ogenius_nds_db_normal_users_id'] == $id_xxxccc88) {
                                                    ?>
                                                    <li><img class="image24" id="a<?php echo "$i_mainPage_posts" . $books_main_page_posts[$i_mainPage_posts]['ogenius_nds_db_community_posts_id']; ?>" onclick="main_page_delete_this_post(this,<?php echo "" . $books_main_page_posts[$i_mainPage_posts]['ogenius_nds_db_community_posts_id']; ?>)" src="images/send_to_dust_bin.png" /></li>
                                            ...
                                            if ($query_main_page_posts_comments = $database->query($sql_main_page_posts_comments)) {
                                                ...
                                                while ($res_main_page_posts_comments = mysqli_fetch_array($query_main_page_posts_comments)) {
                                                    ...
                                                    if ($main_page_cmmnens_c == 0) {
                                                        ?>
                                                        <img class="main_page_comments_collapsible<?php echo "" . $i_mainPage_posts; ?>" onclick="main_page_posts_comments_refresh_up(<?php echo "" . $main_page_the_postId_2017; ?>, this)" src="images/up_new_load.png" style="cursor:pointer;margin-left:40%;width: 30px;height: 30px;border-radius: 5px;box-shadow: 2px 2px 2px gray;border-top: 1px solid gray;border-left: 1px solid gray;" />
                                                        <?php
...
<div class="imagedialog dialog">
    ...
    <div id="image_0">
        ...
        <div id="addimagecaption" class="centerrowspacearound post-area" >
            ...
            <input type="textarea" id="main_pagee_community_suggest_an_Image_2017_caption" placeholder='<?php
...
<div class="videodialog dialog">
    ...
    <div id="video_0">
        ...
        <div id="addimagecaption" class="centerrowspacearound post-area">
            ...
            <input type="textarea" id="main_page_community_suggest_video_caption" placeholder='<?php
            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_55("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_55("system_config_xml/" . $_global_language)->item(0)->textContent;
            } else {
                ?>
                   ...
                   <?php } ?>' onkeyup="textAreaAdjust(this)">
            <div id="sendmessage"> 
                <img src="images/ic_send_black_24dp.png" id="main_page_community_suggest_video_caption" placeholder='<?php
                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_55("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_main_page_55("system_config_xml/" . $_global_language)->item(0)->textContent;
                } else {
                    ?>
...
<script src="js/nds_main.js"></script>
