...
<html lang="en">
    <head>
        ...
        <title>Cropper</title>
        <link rel="stylesheet" href="crop_2017/remote_tools/bootstrap.min.css">
        <link rel="stylesheet" href="crop_2017/dist/cropper.min.css">
        <link rel="stylesheet" href="crop_2017/css/main.css">
    ...
    <body>
            ...
            <div class="modal fade" id="avatar-modal" aria-hidden="true" aria-labelledby="avatar-modal-label" role="dialog" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form class="avatar-form" action="crop.php?theidToFind=<?php echo "" . $id900; ?>" enctype="multipart/form-data" method="post">
        ...
        <script src="crop_2017/jquery/jquery.js"></script>
        <script src="crop_2017/remote_tools/bootstrap.min.js"></script>
        <script src="crop_2017/dist/cropper.min.js"></script>
        <script src="crop_2017/js/main.js"></script>
    </body>
</html>
