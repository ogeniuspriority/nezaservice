    ...
    <div class="container">
        <div class="navbar-header">
            ...
            switch ($indiv_vip_tag_goo) {
                case "0":
                    ?>
            <a class="navbar-brand centerrow" href="main_page.php" style="color: white"> <img class="image24" src="system_images/nds_logo.png">Neza Digital Service </a> 
                    <?php
                    break;
                case "1":
                    ...
                    if ($temp_var_intitution_name == "rgb") {
                        ?>
                        <a class="navbar-brand centerrow" href="main_page_institution_rgb.php" style="color: white"> <img class="image24"  src="system_images/nds_logo.png">Neza Digital Service </a> 
                        <?php
                    } else {
                        ?>
                        <a class="navbar-brand centerrow" href="main_page_institution.php" style="color: white"> <img class="image24"  src="system_images/nds_logo.png">Neza Digital Service </a> 
                        <?php
                    }
