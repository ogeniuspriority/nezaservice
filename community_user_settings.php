        ...
        <div class="row">
            ...
            <div class="col-md-6" id="screen_Notification">
                <h1 class="page-header">
                    <?php
                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_2("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_2("system_config_xml/" . $_global_language)->item(0)->textContent;
                    } else {
                        ?>
                        Notification
                    <?php } ?>
                    ...
                    <table>
                        ...
                        if ($query_notification_new_msg_coming = $database->query($sql_notification_new_msg_coming)) {
                            ...
                            if ($notification_new_msg_coming == 0) {
                                ...
                                <tr>
                                    <td>
                                        <input checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["new_msg_coming"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                    </td>
                                    <td><label><?php
                                ...
                                if ($notification_new_msg_coming_status == 0) {
                                    ...
                                    <tr>
                                        <td>
                                            <input style=""  onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["new_msg_coming"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_18("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_18("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input style="" checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["new_msg_coming"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_18("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_18("system_config_xml/" . $_global_language)->item(0)->textContent;
                        ...
                        if ($query_notification_copy_my_mail_add = $database->query($sql_notification_copy_my_mail_add)) {
                            ...
                            if ($notification_copy_my_mail_add == 0) {
                                ...
                                <tr>
                                    <td>
                                        <input checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["cc_my_mail_add"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                    </td>
                                    <td><label><?php
                                ...
                                if ($notification_copy_my_mail_add_status == 0) {
                                    ...
                                    <tr>
                                        <td>
                                            <input style=""  onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["cc_my_mail_add"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_19("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_19("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input style="" checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["cc_my_mail_add"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_19("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_19("system_config_xml/" . $_global_language)->item(0)->textContent;
...
//---------------Copy my mail address---find in relation links----------------
                        ...
                        if ($query_notification_all_notifications_add = $database->query($sql_notification_all_notifications_add)) {
                            ...
                            if ($notification_all_notifications_add == 0) {
                                ...
                                <tr>
                                    <td>
                                        <input checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["all_notifications"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                    </td>
                                    <td><label><?php
                                ...
                                if ($notification_all_notification_status == 0) {
                                    ...
                                    <tr>
                                        <td>
                                            <input style=""  onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["all_notifications"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_20("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_20("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input style="" checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["all_notifications"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_20("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_20("system_config_xml/" . $_global_language)->item(0)->textContent;
                        ...
                        if ($query_notification_all_notifications_add = $database->query($sql_notification_notify_my_nber)) {
                            ...
                            if ($notification_notify_my_nber == 0) {
                                ...
                                <tr>
                                    <td>
                                        <input checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["notify_my_nber"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                    </td>
                                    <td><label><?php
                                ...
                                if ($notification_notification_notify_my_nber_status == 0) {
                                    ...
                                    <tr>
                                        <td>
                                            <input style=""  onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["notify_my_nber"]; ?>, 'newmsg', '0')"  type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_21("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_21("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input style="" checked="true" onclick="community_user_settings_change_notify_status(<?php echo "" . $notification_validators_2017_ids["notify_my_nber"]; ?>, 'newmsg', '1')"   type="checkbox" />
                                        </td>
                                        <td><label><?php
                                                if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_21("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                    echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_21("system_config_xml/" . $_global_language)->item(0)->textContent;
...
//--------------Tag identifier-------------------
            ...
            <div class="col-md-6" id="screen_Privacy">
                <h1 class="page-header">
                    <?php
                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_4("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_4("system_config_xml/" . $_global_language)->item(0)->textContent;
                    } else {
                        ?>
                        Privacy
                    <?php } ?>
                ...
                <div style="margin: 30px;">
                    <div style="margin-left: 40px;">
                        <h4>=><?php
                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_35("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_35("system_config_xml/" . $_global_language)->item(0)->textContent;
                            } else {
                                ?>
                                ...
                                if ($query_privacy_suggest = $database->query($sql_privacy_suggest)) {
                                    ...
                                    while ($res_privacy_suggest = mysqli_fetch_array($query_privacy_suggest)) {
                                        ...
                                        if ($privacy_suggest_set_txt_descr_1 == 1) {
                                            ...
                                            <tr>
                                                <td>
                                                    <input checked="true" onchange="nds_privacy_suggest_action_tools(this,<?php echo "" . $privacy_suggest_set_id; ?>, '0')" id="nds_privacy_suggest_all_details"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                                        Let all my details be available (default)
                                                    <?php } ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_suggest_action_tools(this,<?php echo "" . $privacy_suggest_set_id; ?>, '1')" id="nds_privacy_suggest_username_and_loc" name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                                        Only my Username and Location be available
                                                    <?php } ?></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_suggest_action_tools(this,<?php echo "" . $privacy_suggest_set_id; ?>, '2')" id="nds_privacy_suggest_username_only"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_38("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_38("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                                        Only my Username
                                                    <?php } ?></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input  onchange="nds_privacy_suggest_action_tools(this,<?php echo "" . $privacy_suggest_set_id; ?>, '0')" id="nds_privacy_suggest_all_details"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            ...
                                            <tr>
                                                <td>
                                                    <input checked="true" onchange="nds_privacy_suggest_action_tools(this,<?php echo "" . $privacy_suggest_set_id; ?>, '1')" id="nds_privacy_suggest_username_and_loc" name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            ...
                                            <tr>
                                                <td>
                                                    <input checked="true" onchange="nds_privacy_suggest_action_tools(this,<?php echo "" . $privacy_suggest_set_id; ?>, '2')" id="nds_privacy_suggest_username_only"  name="suggestionInstan" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_38("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_38("system_config_xml/" . $_global_language)->item(0)->textContent;
...
//------When nothing is registered yet!--------------------------------
                                ...
                                if ($_2017_check_if_real == 0) {
                                    ...
                                    <tr>
                                        <td>
                                            <input checked="true" onchange="nds_privacy_suggest_action_tools(this,<?php echo "23"; ?>, '0')" id="nds_privacy_suggest_all_details"  name="suggestionInstan" type="radio" />
                                        </td>
                                        <td><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_36("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input onchange="nds_privacy_suggest_action_tools(this,<?php echo "23"; ?>, '1')" id="nds_privacy_suggest_username_and_loc" name="suggestionInstan" type="radio" />
                                        </td>
                                        <td><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_37("system_config_xml/" . $_global_language)->item(0)->textContent;
                                    ...
                                    <tr>
                                        <td>
                                            <input onchange="nds_privacy_suggest_action_tools(this,<?php echo "23"; ?>, '2')" id="nds_privacy_suggest_username_only"  name="suggestionInstan" type="radio" />
                                        </td>
                                        <td><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_38("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_38("system_config_xml/" . $_global_language)->item(0)->textContent;
                        ...
                        <h4>=><?php
                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_39("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_39("system_config_xml/" . $_global_language)->item(0)->textContent;
                            } else {
                                ?>
                                Posts
                            <?php } ?></h4>
                                ...
                                while ($res_privacy_posts = mysqli_fetch_array($query_privacy_posts)) {
                                    ...
                                    if ($_privacy_posts_set_txt_descr_1 == 1) {
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input checked="true" id="community_user_settings_privacy_posts_0" onclick="nds_privacy_check_which_posts_0(this)" name="usernameChoice" type="radio" />
                                                </td>
                                                <td><?php
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input name="usernameChoice" id="community_user_settings_privacy_posts_1" onclick="nds_privacy_check_which_posts_0(this)" type="radio" />
                                                </td>
                                                <td><?php
                                                    ...
                                                    <?php } ?></td>
                                                <td>
                                                    <input id="comm_user_settings_MyOtherName" onclick="nds_privacy_check_which_posts_0(this)" type="text" class="accountRegPuts" disabled="disabled" placeholder="<?php
                                                ...
                                                <td>
                                                    <input onclick="nds_privacy_save_which_posts_1()" type="button" value="<?php
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input onclick="nds_privacy_check_which_posts_0(this)" id="community_user_settings_privacy_posts_0" name="usernameChoice" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_40("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_40("system_config_xml/" . $_global_language)->item(0)->textContent;
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input checked="true" id="community_user_settings_privacy_posts_1" onclick="nds_privacy_check_which_posts_0(this)" name="usernameChoice" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_41("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_41("system_config_xml/" . $_global_language)->item(0)->textContent;
                        ...
                        <h4>=><?php
                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_44("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_44("system_config_xml/" . $_global_language)->item(0)->textContent;
                            } else {
                                ?>
                                Sending Queries To Government Institutions
                            <?php } ?></h4>
                        <form>
                            <table >
                                <?php //--------------------------To goverment institution-------------  ?>
                                <?php
                                $_2017_check_privacy_sendingToGovInsti = 0;
                                //----the validators ids-----
                                //$privacy_suggest_2017_ids = array();
                                $sql_sendingToGovInsti = "SELECT * FROM  ogenius_nds_db_privacy_sending_to_gov  WHERE ogenius_nds_db_privacy_sending_to_gov_user_id='{$id_xxxccc88}' ORDER BY   ogenius_nds_db_privacy_sending_to_gov_id DESC LIMIT 1";
                                if ($query_sendingToGovInsti = $database->query($sql_sendingToGovInsti)) {
                                    //---------------------
                                    while ($res_sendingToGovInsti = mysqli_fetch_array($query_sendingToGovInsti)) {
                                        $_2017_check_privacy_sendingToGovInsti++;
                                        //----------------------The language id----------
                                        $_sendingToGovInsti_set_id = $res_sendingToGovInsti['ogenius_nds_db_privacy_sending_to_gov_id'];
                                        $_sendingToGovInsti_set_txt_descr_1 = $res_sendingToGovInsti['ogenius_nds_db_privacy_sending_to_gov_allMyDetails'];
                                        $_sendingToGovInsti_set_txt_descr_2 = $res_sendingToGovInsti['ogenius_nds_db_privacy_sending_to_gov_only_username'];
                                        $_sendingToGovInsti_set_txt_descr_3 = $res_sendingToGovInsti['ogenius_nds_db_privacy_sending_to_gov_username_and_loc'];
                                        //$privacy_suggest_which_choice_2017 = $res_privacy_suggest['ogenius_nds_db_privacy_suggest_records_let_all_my_details_avail'];
                                        //----------Save the notify essesntials--------------
                                        if ($_sendingToGovInsti_set_txt_descr_1 == 1) {
                                            ?>
                                            <tr>
                                                <td>
                                                    <input checked="true" onchange="nds_privacy_check_sending_to_govment_institution(this)" id="send_to_goverment_set_0" name="queriesToGovmnt" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_45("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_45("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                                        All my details will be seen (default)
                                                    <?php } ?>  </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_check_sending_to_govment_institution(this)" name="queriesToGovmnt" id="send_to_goverment_set_1" type="radio" />
                                                </td>
                                                <td> <?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_46("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_46("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                                        Only My Username
                                                    <?php } ?> </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_check_sending_to_govment_institution(this)" id="send_to_goverment_set_2" name="queriesToGovmnt" type="radio" />
                                                </td>
                                                <td> <?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_47("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_47("system_config_xml/" . $_global_language)->item(0)->textContent;
                                                    } else {
                                                        ?>
                                                        Username + Location
                                                    <?php } ?> </td>
                                        ...
                                        if ($_sendingToGovInsti_set_txt_descr_2 == 1) {
                                            ?>
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_check_sending_to_govment_institution(this)" id="send_to_goverment_set_0"  name="queriesToGovmnt" type="radio" />
                                                </td>
                                                <td><?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_45("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_45("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            ...
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_check_sending_to_govment_institution(this)" checked="true" id="send_to_goverment_set_1" name="queriesToGovmnt" type="radio" />
                                                </td>
                                                <td> <?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_46("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_46("system_config_xml/" . $_global_language)->item(0)->textContent;
                                        ...
                                        if ($_sendingToGovInsti_set_txt_descr_3 == 1) {
                                            ?>
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_check_sending_to_govment_institution(this)" id="send_to_goverment_set_0" name="queriesToGovmnt" type="radio" />
                                            ...
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_check_sending_to_govment_institution(this)" id="send_to_goverment_set_1"  name="queriesToGovmnt" type="radio" />
                                                </td>
                                                <td> <?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_46("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_46("system_config_xml/" . $_global_language)->item(0)->textContent;
                                            ...
                                            <tr>
                                                <td>
                                                    <input onchange="nds_privacy_check_sending_to_govment_institution(this)" id="send_to_goverment_set_2" checked="true" name="queriesToGovmnt" type="radio" />
                                                </td>
                                                <td> <?php
                                                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_47("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_47("system_config_xml/" . $_global_language)->item(0)->textContent;
                                ...
                                <?php
                                if ($_2017_check_privacy_sendingToGovInsti == 0) {
                                    ?>
                                    <tr>
                                        <td>
                                            <input onchange="nds_privacy_check_sending_to_govment_institution(this)" id="send_to_goverment_set_0" checked="true" name="queriesToGovmnt" type="radio" />
                                        </td>
                                        <td><?php
                                            if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_45("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                                                echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_45("system_config_xml/" . $_global_language)->item(0)->textContent;
            ...
            <div class="col-md-6" id="screen_Ads">
                <h1 class="page-header">
                    <?php
                    if (!empty($NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_48("system_config_xml/" . $_global_language)->item(0)->textContent)) {
                        echo "" . $NDS_OGENIUS_MAIN_settings::getGeneralSettings_community_user_settings_48("system_config_xml/" . $_global_language)->item(0)->textContent;
                    } else {
                        ?>
                        Manage Ads
                    <?php } ?>
                        ...
                        <div style="margin-top: 20px;">
                            ...
                            <form id="community_user_settings_advert_upload_form">
                                <table>
                                    ...
                                    <tr> <td><input onclick="community_user_settings_save_advert_data()" type="button" style="margin-left: 30%;" class="btn" value="<?php
