...
require_once ("includes/functions.php");
//---------------Link user to suggestion box--
$main_page_institution_rgb_LastId = $_POST['main_page_institution_rgb_LastId'];
$main_page_institution_rgb_LastId = $main_page_institution_rgb_LastId - 10;
$sql_main_page_institution_queries = "SELECT 
            ...
            ON ogenius_nds_db_rgb_query.ogenius_nds_db_rgb_query_query_provider=ogenius_nds_db_normal_users.ogenius_nds_db_normal_users_id
               WHERE ogenius_nds_db_rgb_query.ogenius_nds_db_rgb_query_id > '{$main_page_institution_rgb_LastId}'
                 ORDER BY ogenius_nds_db_rgb_query_id DESC LIMIT 80    ";
